...
{
	TestTrue(TEXT("Current schema includes the schema-four Progression partition"), UPRSaveGame::CurrentSchemaVersion >= 4);
	...
	if (Migrated)
	{
	TestEqual(TEXT("Migrated save reaches the current schema"), Migrated->SchemaVersion, UPRSaveGame::CurrentSchemaVersion);
