...
# 使用规则
只有 `CURRENT_VERSION.md` 指向的版本可以执行。v0.0.0-v0.3.0 已生成独立任务合同；后续任务合同在进入对应阶段前，从路线图和依赖矩阵生成并复核。
...
| v0.3.0 | AI 队友与 QTE 纵切片 | AI 队友数据、关系和主同步结构 | In Progress | v0.2.4 | Versions/v0.3.0.md |
