...
# 使用规则
只有 `CURRENT_VERSION.md` 指向的版本可以执行。已生成合同的范围以本索引实际记录为准；后续任务合同在进入对应阶段前，从
...
| v0.2.1 | 战斗纵切片 | 敌人基类、三种小怪和精英 | Completed | v0.2.0 | Versions/v0.2.1.md |
| v0.2.2 | 战斗纵切片 | 审计者 Boss 纵切片 | Completed | v0.2.1 | Versions/v0.2.2.md |
...
| v0.5.1 | 现实据点、任务和记忆 | 三名 AI 个人任务第一章 | Completed | v0.5.0 | Versions/v0.5.1.md |
| v0.5.2 | 现实据点、任务和记忆 | 记忆摘要与 LLM 对话安全层 | Completed | v0.5.1 | Versions/v0.5.2.md |
| v0.6.0 | 章节内容第一轮 | 第一章：配给官内容包 | Completed | v0.5.2 | Versions/v0.6.0.md |
| v0.6.1 | 章节内容第一轮 | 第二章：守夜者内容包 | Completed | v0.6.0 | Versions/v0.6.1.md |
| v0.6.2 | 章节内容第一轮 | 第三章：抚慰者内容包 | Completed | v0.6.1 | Versions/v0.6.2.md |
| v0.7.0 | 终章与后期高光 | 第四章：审计者完整版 | Completed | v0.6.2 | Versions/v0.7.0.md |
| v0.7.1 | 终章与后期高光 | 第五章：首脑意志投影终章 | Completed | v0.7.0 | Versions/v0.7.1.md |
| v0.7.2 | 终章与后期高光 | 三重共鸣和后期高光技能 | In Progress | v0.7.1 | Versions/v0.7.2.md |
